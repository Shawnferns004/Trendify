        ...
        <div className="w-9/12">
            <div className="flex items-start mb-8">
                ...
                <div className="text-md">
                    <h1 className="text-gray-900 font-semibold mb-2">What might be your first question?</h1>
                    <p className="text-gray-500 text-sm">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores
